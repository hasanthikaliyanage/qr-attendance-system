...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Add New Lecturer</h1>
        <p class="text-gray-600">Fill in the lecturer details below. All fields marked with * are required.</p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.lecturers.store') }}" method="POST" id="lecturerForm">
        @csrf
